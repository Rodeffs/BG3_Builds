...
* When thrown, weapons with the Thrown property use their weapon damage, whereas everything else uses its weight as damage
...
* If you go inside Darkness or Fog Cloud FIRST and then hide, enemies will just skip their turns if there aren't any other valid targets. Combined with hide as a Bonus Action this creates very OP combo, where you can freely attack or cast spells with regular Action and then spend a Bonus Action hiding. Note that this DOES NOT work against enemies who can see through Darkness or can't be blinded
...
* Feat order: Tavern Brawler +1 STR -> Dual Wielder or Athlete +1 STR
* Equipment:
...
* Feat order: Great Weapon Master -> Heavy Armour Master (for War Domain), Heavily Armoured (for Death Domain) or Ability Improvement +2 STR (either Domain, if didn't take +1 STR buff from Ethel) -> Ability Improvement +2 STR
...
* TIP: Use Animate Dead to get Skeletons instead of Zombies before level 9, after that use Flying Ghouls
* Equipment:
...
* Feat order: Tavern Brawler -> Alert
...
* Starting Abilities: 8 STR, 15+1 DEX, 14 CON, 15+2 INT, 10 WIS, 8 CHR
* Feat order: Ability Improvememt +2 DEX -> Ability Improvement +2 INT -> Ability Improvement +2 DEX
* TIP: Dual wield weapons in order to use Bonus Action. After you get Bhaalist Armour in Act 3, use two piercing weapons
